...
class Review(BaseModel):
    ...
    sentiment: Literal["positive", "negative"] = Field(..., description="Return sentiment of the review that will be either positive, negative or neutral")
...
# res = strctured_model.invoke("The hardware is great, but the software feels bloated. There are too many pre-installed apps that I can't remove. Also, the U looks outdated compared to other brands. Hoping for a software update to fix this")
